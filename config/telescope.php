...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The following array lists the paths and commands that Telescope will
    | ignore from its data collection. This list is only applied when
    ...
    */
    ...
    | or command is executed. Feel free to customize this list as needed.
    |
    */
